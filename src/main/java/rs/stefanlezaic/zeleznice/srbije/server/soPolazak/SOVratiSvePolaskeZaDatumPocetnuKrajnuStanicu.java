 ...
 * @author Stefan
 */
public class SOVratiSvePolaskeZaDatumPocetnuKrajnuStanicu extends AbstractGenericOperation  {
    ...
    protected void execute(Object entity) throws Exception {
           try {
            polasci = databaseBroker.findAllDeparture(new Polazak(),((Polazak) entity));
